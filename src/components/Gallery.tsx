...
const CATEGORIES = ["All Products", "Self-Inking Stamps", "Company Seals", "Office Mohars", "Packaging & Logos", "Administrative Stamps"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-slate-500 text-sm mt-3">
            Browse our wide selection of pre-inked Japanese flash stamps, heavy metal handle daters, and custom company seals ready for express ship in Greater Noida West.
          </p>
        </div>
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="pt-2 border-t border-slate-50 flex items-center justify-between">
                  <span className="text-xs text-slate-400 font-medium">Ready in 2-3 Hours</span>
                  <a
        ...
        {filteredItems.length === 0 && (
          <div className="text-center bg-white rounded-3xl p-12 border border-dashed border-slate-200">
            <p className="text-slate-500 text-sm">No specialized options found under this category. Contact us directly to custom forge it!</p>
          </div>
        )}
